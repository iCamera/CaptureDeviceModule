...
if options.update_fruitstrap || !File.exist?($fruitstrap_executable)
  ...
  Dir.chdir($temp_path) do
    ...
    # execute("git clone #{quiet} git://github.com/ghughes/fruitstrap.git", options.verbose)
    execute("git clone #{quiet} git://github.com/walm/fruitstrap.git", options.verbose)
